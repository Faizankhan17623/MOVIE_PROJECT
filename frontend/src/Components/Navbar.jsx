        ...
        <div className='py-4 pl-6'>
         ...
         <div className= 'w-[450px]  py-4 px-3'>
            <ul className={`flex justify-between items-center h-full ${darkmode ? 'text-white' : 'text-black'}`}>
                ...
                <div className={`hover:text-yellow-500 ${darkmode ? 'text-white' : 'text-black'} ${path === '/Movies' ? 'text-yellow-200' : ''} flex items-center gap-1 group relative z-10`}>
...
<div className={`hover:text-yellow-500 ${darkmode ? 'text-white' : 'text-black'} ${path === '/Theatres' ? 'text-yellow-200' : ''} flex items-center gap-1 group relative z-10`}>
